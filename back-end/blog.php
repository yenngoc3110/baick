<?php
    ...
    if(isset($_POST["submit"])){
        ...
        insert_blog_admin($id, $image, $title, $content);
    }
    
    //$data = get_list_blog_admin();
                            ...
                            <div class="header-button">
                                ...
                                <div class="account-wrap">
                                    <div class="account-item clearfix js-item-menu">
                                        ...
                                        <div class="content">
                                            <a class="js-acc-btn" href="#">Yen Ngoc</a>
                                        </div>
                                        <div class="account-dropdown js-dropdown">
                                            <div class="info clearfix">
                                                ...
                                                <div class="content">
                                                    <h5 class="name">
                                                        <a href="https://www.facebook.com/gemme.n3110">Yen Ngoc</a>
                                                    </h5>
