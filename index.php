...
<html lang="en">
			...
			<div class="hero-wrap js-fullheight" style="background-image: url(images/bg_1.jpg);" data-stellar-background-ratio="0.5">
				...
				<div class="js-fullheight d-flex justify-content-center align-items-center">
					<div class="col-md-8 text text-center">
						<div class="img mb-4 avatar" style="background-image: url(images/avatar2.jpg);background-size:300px"></div>
						<div class="desc">
							<h2 class="subheading">Hello I'm</h2>
							<h1 class="mb-4">Yen Ngoc</h1>
							<p class="mb-4">Tôi là sinh viên năm 2 trường CDKT cũng là 1 blogger</p>
							<p><a href="http://127.0.0.1:8080/ngoc/Admin/front-end/about.php" class="btn-custom">More About Me <span class="ion-ios-arrow-forward"></span></a></p>
						</div>
					</div>
				</div>
			</div>
          ...
          <div class="col-md">
            <div class="ftco-footer-widget mb-4">
            	...
            	<div class="block-23 mb-3">
	              <ul>
	                <li><span class="icon icon-map-marker"></span><span class="text">TPHCM</span></li>
	                <li><a href="#"><span class="icon icon-phone"></span><span class="text">+84386163751</span></a></li>
	                <li><a href="#"><span class="icon icon-envelope"></span><span class="text">yenngocliu@gmail.com</span></a></li>
	              </ul>
	            </div>
            </div>
          </div>
  ...
  Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with <i class="icon-heart" aria-hidden="true"></i> by <a href="https://www.facebook.com/gemme.n3110" target="_blank">Yen Ngoc</a>
